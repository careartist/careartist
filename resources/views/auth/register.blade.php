...
<div class="container">
    <div class="row">
        ...
        @if (Session::has('new_reg_message'))
            <div class="alert alert-info">{{ Session::get('new_reg_message') }}</div>
        @else
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('screen_name') ? ' has-error' : '' }}">
                            <label for="screen_name" class="col-md-4 control-label">Screen Name</label>
